...
export const LandingToggleFilter = ({ filter }: { filter: Filter }) => {
  const form = useForm({
    defaultValues: {
  ...
  <FilterForm.Field
    ...
    children={(field) => {
      return (
        ...
        >
          <SelectTrigger className="w-[145px] border border-neutral-200 bg-white shadow-[0px_20px_70px_-10px_hsla(227,30%,20%,0.08),0px_10px_24px_-8px_hsla(227,30%,20%,0.04),0px_1px_4px_-1px_hsla(227,30%,20%,0.06)]">
            <SelectValue />
          </SelectTrigger>
          <SelectContent className="w-[155px]">
    ...
    children={(field) => {
      return (
        <Select
          ...
          value={field.state.value}
        >
          <SelectTrigger className="w-[140px] border border-neutral-200 bg-white shadow-[0px_20px_70px_-10px_hsla(227,30%,20%,0.08),0px_10px_24px_-8px_hsla(227,30%,20%,0.04),0px_1px_4px_-1px_hsla(227,30%,20%,0.06)]">
            <SelectValue />
          </SelectTrigger>
