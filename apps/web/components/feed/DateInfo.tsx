        ...
        {(props.i == 0 ||
          ...
          <>
            ...
            new Date().toDateString() ? (
              <h4 className="ml-5 pt-4 text-xs font-[500] tracking-wider text-neutral-500 dark:text-neutral-500/70">
                Today
              </h4>
            ) : props.items[props.i]?.created_at.toDateString() ==
              new Date(Date.now() - 1).toDateString() ? (
              <h4 className="ml-5 pt-6 text-xs font-[500] tracking-wider text-neutral-500 dark:text-neutral-500/70">
                Yesterday
              </h4>
            ) : (
              <h4 className="ml-5 pt-6 text-xs font-[500] tracking-wider text-neutral-500 dark:text-neutral-500/70">
