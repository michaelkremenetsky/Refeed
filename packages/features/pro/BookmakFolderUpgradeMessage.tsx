  ...
  return (
    <>
      ...
      <div className="mx-auto w-11/12">
        ...
        <h3
          className={`pointer-events-none mt-1 rounded-md text-center text-neutral-700/65 dark:text-stone-300`}
        >
...
const EmptyMessageSvgForFolder = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      className="box-shadow-[rgba(0,0,0,0.05)_0px_0px_1px,rgba(0,0,0,0.04)_0px_15px_30px] fill-neutral-50 stroke-[#d1d4d6] dark:fill-[#141415] dark:stroke-[#232329]"
    />
    <path
      strokeWidth={1.5}
